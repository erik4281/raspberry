...
curl -s -H "Accept: application/json" -X PUT --data '{"conditions": [{"address": "/config/localtime","operator": "in","value": "T05:00:00/T00:00:00"}, {"address": "/sensors/57/state/presence","operator": "eq","value": "true"}, {"address": "/sensors/57/state/presence","operator": "dx"}, {"address": "/sensors/55/state/status","operator": "lt","value": "1"}, {"address": "/sensors/42/state/dark","operator": "eq","value": "true"}]}' http://${HUE_IP}/api/${HUE_USER}/rules/1/
